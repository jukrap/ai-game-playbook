---
source: README.md
source_sha256: dba111b90b8630ad482c9a74205094d7baa6c4eb105a9cf1db8126e9dc9ab426
...
| Windows 격리 | 폐기 가능한 AppContainer 자체 검사와 일회성 합성 실행. 사용자 프로젝트와 엔진은 실행하지 않음 |
...
격리 검증은 Windows x64에서 개발자가 선택해 실행하며 .NET SDK `10.0.400`이 필요합니다. 먼저 격리 정책을 검사하고, 방금 성공한 결과로 새 폐기 가능 스냅샷을 읽는 고정 합성 작업 하나만 허용합니다. 이 기능은 비공개 API이며 임의 명령과 사용자 프로젝트 경로를 받지 않습니다. 엔진 지원을 성립시키지도 않습니다.
