---
source: README.md
source_sha256: 45742e073e998d04d03ba356caabd947da4995986bfa6bd941248dd7698935ea
...
- 원본 version report, exact project/executable identity, 유한한 registered workflow 하나, 고정 startup argument, 세 번째 signed approval을 bind하는 internal-only Godot headless-preflight admission. Project-write, network, child-process containment가 구현되지 않았으므로 engine process를 시작하지 않고 lease를 명확한 실패로 정산하며 canonical `blocked` receipt를 보존하고 support를 `planned`로 유지합니다.
