...
> Status: public design and implementation-status package, reviewed on 2026-08-26. The control-plane foundation and one read-only CLI command are in progress.
...
| [CLI status](planned-cli.md) | Available `agpb doctor` behavior and the remaining planned command groups |
