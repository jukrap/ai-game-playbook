...
> Status: public design and implementation-status package, reviewed on 2026-08-26. The control-plane foundation and three source-built write-free CLI commands are in progress.
...
| [CLI status](planned-cli.md) | Available `agpb init`, `agpb doctor`, and `agpb project inspect` behavior plus the remaining planned groups |
