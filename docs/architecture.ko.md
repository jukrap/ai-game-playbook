...
source_sha256: 67e16ee3ac2dbe401a960d5d41a782df2047af15401c11b3193d86c2f243e98d
translated_at: 2026-08-27
---

# 목표 아키텍처

> 상태: 일부 control plane이 구현된 목표 아키텍처입니다. Contract, runtime registry, core 안전 primitive, durable private receipt record와 artifact object, pure process/test result normalization, 제한된 retained-artifact assessment, managed-pack transaction, plan-only `agpb init`, read-only `agpb doctor`, static read-only `agpb project inspect`가 존재합니다. General mutation dispatch, evidence export, MCP runtime, host integration, engine, bridge는 계획 단계입니다.
