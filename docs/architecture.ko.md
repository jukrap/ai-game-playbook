...
source_sha256: 1b4f1f718e31eeff15de4a1bbf8411f2fb3dc909d21a66b940146e134f67746c
...
| `windows-containment-provider` | Windows x64 산출물 식별, 폐기 가능한 격리 자체 검사, 일회성 합성 격리 실행 권한 |
...
이 경로는 격리 승인 검사이지 엔진 어댑터가 아닙니다. 핵심 제공자 목록은 계속 비어 있으며, 공개 명령·MCP 도구·Godot 사전 검사·사용자 프로젝트 경로·임의 실행 파일에서는 이 기능에 접근할 수 없습니다.
