...
source_sha256: e27cc848a84aaf69cf48fa7bd23357a6a5d16c958c56ac60891b0bf79358dcd3
...
| `pack-runtime` | 일부 구현 | write-free validated-registry preflight, broker/lane 결합 local add, update, installed-state 소유권 기반 remove, CAS promotion, 명확한 실패의 rollback, effect settlement, active-transaction barrier, append-only journal 검증, 제한된 read-only recovery 분류가 존재하며 pack 소유 artifact directory lifecycle, CLI 통합, 승인 결합 recovery finalization, 분산 pack 획득은 계획 단계 |
