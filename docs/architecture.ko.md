...
source_sha256: 6c46bcb94a902c8e52063262c3622b6e7b0fedfe142322f1730bc06b15e4e1c6
...
| `pack-runtime` | 일부 구현 | write-free validated-registry preflight와 broker/lane 결합 local add, update, installed-state 소유권 기반 remove, CAS promotion, 명확한 실패의 rollback, effect settlement, append-only transaction 검증이 존재하며 pack 소유 artifact directory lifecycle, CLI 통합, 중단 transaction reconciliation, 분산 pack 획득은 계획 단계 |
