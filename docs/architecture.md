...
| `evidence` | Partial private foundation | Canonical receipt records, content-addressed artifact bytes, and producer-bound manifests exist; format QA, retention, migration, listing, and explicit export remain planned |
