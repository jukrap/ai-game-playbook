...
source_sha256: 61204931133bae0915c482f23b7a1a2688cf2d92554465ba3c3d4a1e0b441c64
translated_at: 2026-08-29
---
# 로드맵

> 상태: 소스에서 실행하는 제어 계층 기반과 Windows x64 격리 자체 검사를 개발하고 있습니다. 엔진 어댑터, 공개 변경 기능, 배포 패키지, 검증된 골든 프로젝트는 아직 남아 있습니다.
...
- 폐기 가능한 파일·네트워크·자식 프로세스·종료·정리 검사를 갖춘 Windows x64 AppContainer·Job Object 자체 검사
...
- 검증한 Windows x64 격리 자체 검사를 최신 프로젝트 스냅샷, 일회성 프로세스 승인, 제한된 실행 권한에 연결
