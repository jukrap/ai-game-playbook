...
source_sha256: b3a3a7626946286ca97ded7f73595456c89c899fb683f8a2e29399c512086215
...
- Windows x64 AppContainer·Job Object 검증, 일회성 스냅샷 입장권, 복사본 Godot 프로세스 실행, 권한 정산, 영수증 보존
- 구조 검사가 있는 영문·한국어 공개 문서 쌍

격리 프로세스 경로는 전용 시험 실행 파일로 성공과 고장 주입 사례를 통과했습니다. 아직 설치 가능한 패키지, 설치된 Godot 검증, 실엔진 전체 흐름은 없습니다.
