...
source_sha256: 99effed31f16f25d1d63c5c5ba4a825b34dbf680d2995439412ef5929682cdcb
...
- Project inspection에서만 적격한 static Godot capability routing을 수행하며 filesystem mutation 없이 machine-specific local-only Codex project MCP configuration 하나와 registry-derived capability-first skill target 열한 개를 deterministic하게 계획하고 검사하고, fixed target에 대한 private same-process two-observation materialization 준비를 수행하는 경계.
