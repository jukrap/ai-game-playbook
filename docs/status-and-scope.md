...
All Godot, Unity, and Unreal capabilities remain `planned`. Availability of `init`, `doctor`, `project inspect`, `skill list`, and `skill check` is a control-plane command status, not engine evidence.
