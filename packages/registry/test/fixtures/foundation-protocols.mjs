...
export const validFoundationProtocolFixtures = {
  ...
  "godot-persistence-cycle-expectation": {
    ...
    freshStateHash: digest,
    persistedStateHash: secondDigest,
    expectationDigest: digest,
  },
  "godot-persistence-cycle-report": {
    schemaVersion: "1.0.0",
    commandId: "engine.persistence-cycle",
    controlPlaneVersion: "0.0.0",
    registryDigest: digest,
    runId,
    workflow: {
      id: "workflow.godot-persistence-cycle",
      version: "1.0.0",
      stepId: "step.godot-persistence-cycle",
      resolvedPlanDigest: secondDigest,
    },
    project: {
      id: "golden.graybox.godot",
