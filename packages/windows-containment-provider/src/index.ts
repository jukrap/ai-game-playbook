...
export type {
  ...
  PreparedWindowsContainedGodotCaptureRun,
  ...
  PrepareWindowsContainedGodotCaptureRunRequest,
  ...
  RunWindowsContainedGodotCaptureRequest,
  ...
  WindowsContainedGodotCaptureExecution,
